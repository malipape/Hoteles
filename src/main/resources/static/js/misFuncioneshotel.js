function traerInformacion(){
	$.ajax({    
    url : 'http://129.151.116.255:8080/api/Room/all',
    type : 'GET',
    dataType : 'json',
...
function guardarInformacion(){
	...
	if (selected.length > 0) {
		...
		$.ajax(    
		'http://129.151.116.255:8080/api/Room/save',
		{data: datosJson,
		type : 'POST',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
...
function editarRegistro (id){
	$.ajax({    
    url : 'http://129.151.116.255:8080/api/Room/'+id,
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function actualizarInformacion(){
	...
	let datosJson = JSON.stringify(misDatos); 
	$.ajax(    
    'http://129.151.116.255:8080/api/Room/update',
	{data: datosJson,
    type : 'PUT',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
