function traerInformacion(){
	$.ajax({    
    url : 'http://129.151.116.255:8080/api/Category/all',
    type : 'GET',
    dataType : 'json',
...
function guardarInformacion(){
		...
		$.ajax(    
		'http://129.151.116.255:8080/api/Category/save',
		{data: datosJson,
		type : 'POST',
		dataType : 'json',
		contentType: "application/json; charset=utf-8",
...
function actualizarInformacion(){
	...
	let datosJson = JSON.stringify(misDatos); 
	$.ajax(    
    'http://129.151.116.255:8080/api/Category/update',
	{data: datosJson,
    type : 'PUT',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function eliminarRegistro(id){
	$.ajax({    
        url : 'http://129.151.116.255:8080/api/Category/'+id,
        type : 'DELETE',
        dataType : 'json',
        contentType: "application/json; charset=utf-8",
...
function editarRegistro (id){
    ...
    success : function(respuesta) {
		console.log(respuesta+ "url" + "http://129.151.116.255:8080/api/Category/"+id);
        let miTabla = '<table>';
